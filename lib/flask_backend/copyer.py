...
def index(latitude,longitude,currentdate):
    ...
    today_plusone=datetime.timestamp(datetime.today() + timedelta(days=1))
    today_plustwo=datetime.timestamp(datetime.today() + timedelta(days=2))
    today_plusthree=datetime.timestamp(datetime.today() + timedelta(days=3))
    today_plusfour=datetime.timestamp(datetime.today() + timedelta(days=4))
    today_plusfive=datetime.timestamp(datetime.today() + timedelta(days=5))
    predict_weather(today_plusone)
    predict_weather(today_plustwo)
